...
Filter.render = function(modal_state, query_state, dim, axis, lang) {
  ...
  return [
	  h('div', h('button.secondary', { 'ev-click': hg.send(query_state.channels.toggleAllFilterValues, dim) }, [ msgs_i18n.filter_button_all ])),
	  ...
	  h('div', h('button.secondary', { 'ev-click': hg.send(query_state.channels.addDimension, { axis: axis, dim: dim }) }, [ msgs_i18n.ok ])),
	]
